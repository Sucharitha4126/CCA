        ...
        <form onSubmit={submit} className="glass rounded-lg p-5 sm:p-7">
          <div className="mb-6 flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-cyan-200">SentinelPay onboarding</p>
              <h1 className="text-2xl font-bold sm:text-3xl">Open a simulated bank account</h1>
            </div>
          ...
          {step === 2 && (
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-lg border border-emerald-300/20 bg-emerald-400/10 p-4 text-sm text-emerald-100 sm:col-span-2">
                A unique public/private key pair is generated for this simulated account. Transfers are signed and verified before settlement.
              </div>
            </div>
          )}
