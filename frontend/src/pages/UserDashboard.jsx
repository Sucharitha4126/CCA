...
export default function UserDashboard() {
  ...
  function exportCsv() {
    ...
    link.download = 'kavach-transactions.csv'
    link.click()
  }
    ...
    <Layout>
      <div className="mb-7 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-400">{user?.bank_name || 'Kavach Trust Bank'} / {user?.account_number || 'Pending'} / {user?.account_type || 'Savings'}</p>
        </div>
