  ...
  return (
    <div className="min-h-screen overflow-hidden grid-bg">
      ...
      <section id="about" className="mx-auto max-w-7xl px-4 py-14 text-sm leading-7 text-slate-400 sm:px-6">
        <p className="max-w-3xl">Kavach combines simulated digital banking, AI fraud scoring, transaction controls, and administrator-only network intelligence in a polished fintech SaaS experience.</p>
      </section>
      <footer className="mx-auto max-w-7xl px-4 py-8 text-sm text-slate-500 sm:px-6">Kavach RiskOps (c) 2026</footer>
    </div>
  )
}
